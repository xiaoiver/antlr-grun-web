...
import { AlterByAnalyzePartitiionContext } from "./MySqlParser";
...
export interface MySqlParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the `alterByAnalyzePartitiion`
	 * labeled alternative in `MySqlParser.alterSpecification`.
	 * @param ctx the parse tree
	 */
	enterAlterByAnalyzePartitiion?: (ctx: AlterByAnalyzePartitiionContext) => void;
	/**
	 * Exit a parse tree produced by the `alterByAnalyzePartitiion`
	 * labeled alternative in `MySqlParser.alterSpecification`.
	 * @param ctx the parse tree
	 */
	exitAlterByAnalyzePartitiion?: (ctx: AlterByAnalyzePartitiionContext) => void;
